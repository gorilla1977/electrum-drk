...
try:
    ...
    print_msg("Warning: xcoin_hash not available, using fallback")
...
class Blockchain(threading.Thread):
    ...
    def __init__(self, config, network):
        ...
        self.local_height = 0
        self.running = False
        self.headers_url = 'http://ec2-54-211-136-164.compute-1.amazonaws.com/blockchain_headers'
    ...
    def get_target(self, index, chain=None):
        ...
        # Darkcoin: go back the full period unless it's the first retarget
        if index == 1:
